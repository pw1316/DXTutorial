#ifndef __PW_ENTITY_FONT__
#define __PW_ENTITY_FONT__
#include <stdafx.h>
...
namespace PW
{
    namespace Entity
    {
        ...
        public:
            ...
            void Shutdown();
            void Render(ID3D11Device *device, ID3D11DeviceContext *context, const std::string &text, const D3DXVECTOR2 &pos, D3DXMATRIX proj);
        private:
            /* Resources */
